package com.geekbrains.geekmarket.repositories.Specification;
...
public class ProductSpecs {
    ...
    public static Specification<Product> categorytitleContains(String word){
        return  (Specification<Product>) (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.like(root.get("category.title"), "%"+word+"%");
    }
