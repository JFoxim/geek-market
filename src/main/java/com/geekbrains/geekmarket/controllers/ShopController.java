...
//    }
    ...
    @GetMapping("/na/{titleFilter}/{categoryTitleFilter}/{priceMin}/{priceMax}")
    public String naShopPage(Model model, @PathVariable(name = "titleFilter") String titleFilter,
                             @PathVariable(name = "categoryTitleFilter") String categoryTitleFilter,
                             @PathVariable(name = "priceMin") String priceMin,
                             @PathVariable(name = "priceMax") String priceMax){
        ...
        if (titleFilter != null && !titleFilter.isEmpty()){
                ProductSpecs.titleContains(titleFilter);
        }
        if (categoryTitleFilter != null && !categoryTitleFilter.isEmpty()){
            ProductSpecs.categorytitleContains(categoryTitleFilter);
        }
        if (priceMin != null && Double.valueOf(priceMin) > 0.0){
            specification.and(ProductSpecs.priceLesserThanOrEq(100.0));
        }
        if (priceMax != null && Double.valueOf(priceMax) < 0.0){
            specification.and(ProductSpecs.priceGreaterThanOrEq(100.0));
        }
